...
3.Valores válidos e inválidos del campo `name`
4.Longitud mínima y máxima permitida
5.Tipos de datos incorrectos
6.Implementé pruebas automatizadas utilizando **Pytest** y **Requests**.
7.Ejecuté las pruebas desde la terminal y validé las respuestas de la API.
8.Documenté los resultados obtenidos durante la ejecución de las pruebas.
